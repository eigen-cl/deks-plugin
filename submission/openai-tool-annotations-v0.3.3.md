# DEKS v0.3.3 — tool annotation worksheet
...
| `upload_asset` | false | false | false | Admits one explicitly attached file into the user's private presentation and returns its reusable asset ID without publishing it. |
