...
`openai-tool-annotations-v0.3.2.md` and paste its per-tool justification. Fix the
...
`openai-review-cases-v0.3.2.json`. Do not shorten their expected behavior,
...
Paste the complete contents of `release-notes-v0.3.2.md`.
