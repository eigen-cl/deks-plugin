...
The distributed plugin uses OAuth. Install it, reload plugins if requested, and run `/mcp` to authenticate in the browser. The root `.mcp.json` intentionally contains no shared token or static authorization header.
